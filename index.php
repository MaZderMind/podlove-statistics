...
<html lang="de">
	<head>
		...
		<script type="text/javascript">var l18n = <?=json_encode(json_decode(file_get_contents('l18n/de.json')))?>;</script>
		<script type="text/javascript" src="res/DateRangePicker.js"></script>
